...
sys.path.insert(1, 'C:/Users/ADMIN/Desktop/Racing_Bet_Project/Racing_Bet_Project')
...
def MiniGame():
    ...
    coin_symbol = pygame.image.load('Dino-Game/resources/coin.png').convert_alpha()

    time_clock = pygame.time.Clock()
    pygame.display.set_caption("Dino Run ")

    jump_sound = pygame.mixer.Sound('Dino-Game/sound/jump.wav')
    die_sound = pygame.mixer.Sound('Dino-Game/sound/die.wav')
    checkPoint_sound = pygame.mixer.Sound('Dino-Game/sound/checkPoint.wav')
    ...
    class Scoreboard():
        ...
        def draw(self):
            screen_layout_display.blit(coin_symbol,(520,15))
            screen_layout_display.blit(self.image, self.rect)
        ...
        while not g_exit:
            ...
            while g_Over:
                ...
                while True:
                    ...
                    scoreRect = score.get_rect(center = (SCREEN_WIDTH // 2, SCREEN_HEIGHT // 2 + 50))
                    
                    textRect = text.get_rect(center = (SCREEN_WIDTH // 2, SCREEN_HEIGHT // 2))

                    SCREEN.blit(score, scoreRect)
                    SCREEN.blit(text, textRect)
                    SCREEN.blit(coin_symbol,(327,118))
                    pygame.display.update()
